    ...
    <section id="location" className="py-24 bg-[#0A0A0A]">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="relative h-[500px] w-full bg-muted rounded-lg overflow-hidden border border-white/10 flex flex-col">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-card/90 backdrop-blur border border-white/10 p-8 rounded max-w-sm hidden md:block">
