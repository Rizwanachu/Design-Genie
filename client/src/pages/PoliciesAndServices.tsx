                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    ...
                    {service.link ? (
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white transition-colors font-display font-bold tracking-widest uppercase text-sm px-4 py-2 rounded-md"
                      >
